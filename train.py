# Train a race classifier on the biased FairFace training set using:
#   precomputed "image_features" -> multinomial Logistic Regression
# and evaluate it on a balanced test set, reporting accuracy per race.
...
for race in all_races:
    ...
    # Rate of being predicted as own race
